...
A `ForestWelcome` component SHALL exist at `src/slides/ForestWelcome/ForestWelcome.tsx`. It SHALL use the `Slide` shell component and render placeholder content as children and picture props.
